    ...
    def __init__(self, db_path: Optional[str] = None):
        if db_path is None:
            ...
            if getattr(sys, 'frozen', False):
                ...
                # 打包后的应用内路径
                possible_paths.append(os.path.join(bundle_dir, 'assets', 'laws.db'))
                possible_paths.append(os.path.join(exe_dir, '..', 'Resources', 'assets', 'laws.db'))
                possible_paths.append(os.path.join(exe_dir, 'assets', 'laws.db'))
                # 也尝试 laws_dev.db
