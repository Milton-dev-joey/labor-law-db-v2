...
class CaseEditDialog(QDialog):
    ...
    def _create_ui(self):
        ...
        self.type_combo.addItems(["我司案例", "参考案例"])
...
class CasePanel(QWidget):
    ...
    def _create_ui(self):
        ...
        self.type_filter.addItems(["全部", "我司案例", "参考案例"])
    ...
    def _load_cases(self):
        ...
        for case in cases:
            ...
            # 类型标记
            type_mark = "【我司】" if case.case_type == "actual" else "【参考】"
...
class CaseDetailDialog(QDialog):
    ...
    def _create_ui(self):
        ...
        # 类型标签
        type_label = QLabel("我司案例" if self.case.case_type == "actual" else "参考案例")
        ...
        if self.case.tags:
            ...
            tags_label.setStyleSheet("color: #757575; margin: 8px 0;")
